...
1. **During Build**: All `.just` files in this directory are consolidated and copied to `/usr/share/ublue-os/just/zz-custom.just` in the image
...
2. If on a bootc system: `sudo bootc switch --target localhost/fedora-bluefin:stable`
